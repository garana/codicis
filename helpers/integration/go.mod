module github.com/garana/codicis/helpers/integration

go 1.25.0

replace github.com/garana/codicis/helpers => ../
...
require (
	...
	github.com/garana/codicis/helpers v0.0.0-00010101000000-000000000000
